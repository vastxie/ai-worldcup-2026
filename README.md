...
连每日战报都由 AI 执笔。后来项目大了，又拉来 Codex 做了一轮生产级硬化和代码审计——
于是变成了 AI 写代码、AI 审 AI 的代码。
...
> 🤖 本项目 100% 由 AI 完成，不含任何手工代码。骨架由 Claude 一路写就（模型从 Fable 5 换到 Opus 4.8），
> 上线后又拉来 Codex 做了一轮并发安全、幂等与隐私的硬化审计——AI 写代码、AI 审 AI 的代码，
> AI 还在竞技场里互相拆台。人类全程只负责提需求和挑毛病，包括这句话。
